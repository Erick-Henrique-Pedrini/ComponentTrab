<script setup>
 defineEmits(['increment-to-cart', 'decrement-to-cart'])
 defineProps(['cart'])
</script>
<template>
    <section class="cart">
  ...
  <button @click='$emit("increment-to-cart", book)' class="plain">
    <span class="mdi mdi-minus" />
  </button>
  {{ book.quantity }}
  <button @click='$emit("decrement-to-cart",book)' class="plain">
